...
public class NominationResourceIntTest {
    ...
    private static final Integer DEFAULT_REQUESTED_RCPT_QTY = 1;
    private static final Integer UPDATED_REQUESTED_RCPT_QTY = 2;

    private static final Integer DEFAULT_REQESTED_DLVRY_QTY = 1;
    private static final Integer UPDATED_REQESTED_DLVRY_QTY = 2;

    private static final Integer DEFAULT_SCHEDULED_RCPT_QTY = 1;
    private static final Integer UPDATED_SCHEDULED_RCPT_QTY = 2;

    private static final Integer DEFAULT_SCHEDULED_DLVRY_QTY = 1;
    private static final Integer UPDATED_SCHEDULED_DLVRY_QTY = 2;
