...
public class RateSchedResource {
    ...
    @Timed
    public ResponseEntity<RateSchedDTO> createRateSched(@RequestBody RateSchedDTO rateSchedDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<RateSchedDTO> updateRateSched(@RequestBody RateSchedDTO rateSchedDTO) throws URISyntaxException {
