...
public class NominationResource {
    ...
    @Timed
    public ResponseEntity<NominationDTO> createNomination(@RequestBody NominationDTO nominationDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<NominationDTO> updateNomination(@RequestBody NominationDTO nominationDTO) throws URISyntaxException {
