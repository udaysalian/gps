...
public class BusinessAssociateAddressResource {
    ...
    @Timed
    public ResponseEntity<BusinessAssociateAddressDTO> createBusinessAssociateAddress(@RequestBody BusinessAssociateAddressDTO businessAssociateAddressDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<BusinessAssociateAddressDTO> updateBusinessAssociateAddress(@RequestBody BusinessAssociateAddressDTO businessAssociateAddressDTO) throws URISyntaxException {
