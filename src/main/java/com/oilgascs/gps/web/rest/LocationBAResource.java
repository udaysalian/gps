...
public class LocationBAResource {
    ...
    @Timed
    public ResponseEntity<LocationBADTO> createLocationBA(@RequestBody LocationBADTO locationBADTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<LocationBADTO> updateLocationBA(@RequestBody LocationBADTO locationBADTO) throws URISyntaxException {
