...
public class ContrLocResource {
    ...
    @Timed
    public ResponseEntity<ContrLocDTO> createContrLoc(@RequestBody ContrLocDTO contrLocDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<ContrLocDTO> updateContrLoc(@RequestBody ContrLocDTO contrLocDTO) throws URISyntaxException {
