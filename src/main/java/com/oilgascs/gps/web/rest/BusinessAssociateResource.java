...
public class BusinessAssociateResource {
    ...
    @Timed
    public ResponseEntity<BusinessAssociateDTO> createBusinessAssociate(@RequestBody BusinessAssociateDTO businessAssociateDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<BusinessAssociateDTO> updateBusinessAssociate(@RequestBody BusinessAssociateDTO businessAssociateDTO) throws URISyntaxException {
