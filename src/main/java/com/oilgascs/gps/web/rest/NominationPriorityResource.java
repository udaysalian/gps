...
public class NominationPriorityResource {
    ...
    @Timed
    public ResponseEntity<NominationPriorityDTO> createNominationPriority(@RequestBody NominationPriorityDTO nominationPriorityDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<NominationPriorityDTO> updateNominationPriority(@RequestBody NominationPriorityDTO nominationPriorityDTO) throws URISyntaxException {
