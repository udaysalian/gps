...
public class ReductionReasonResource {
    ...
    @Timed
    public ResponseEntity<ReductionReasonDTO> createReductionReason(@RequestBody ReductionReasonDTO reductionReasonDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<ReductionReasonDTO> updateReductionReason(@RequestBody ReductionReasonDTO reductionReasonDTO) throws URISyntaxException {
