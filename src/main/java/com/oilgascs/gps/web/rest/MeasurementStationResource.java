...
public class MeasurementStationResource {
    ...
    @Timed
    public ResponseEntity<MeasurementStationDTO> createMeasurementStation(@RequestBody MeasurementStationDTO measurementStationDTO) throws URISyntaxException {
    ...
    @Timed
    public ResponseEntity<MeasurementStationDTO> updateMeasurementStation(@RequestBody MeasurementStationDTO measurementStationDTO) throws URISyntaxException {
